...
本项目是由 [Websoft9](https://www.websoft9.com) 研发的 **云原生程序** ，大大简化 Nextcloud 复杂的安装及配置。

## 系统要求

安装本项目，确保符合如下的条件（[详细参考](https://github.com/nextcloud/docker)）：
...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r nextcloud
...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r nextcloud -p
```
2.复制package包后安装
...
```
git clone --depth=1 https://github.com/Websoft9/docker-nextcloud
cd docker-nextcloud
...
| 名称 | 端口号 | 用途 |  必要性 |
| --- | --- | --- | --- |
| Nextcloud | 9001 | 浏览器访问 Nextcloud | Y |
| MySQL | 3306 | MySQL 远程端口 | N |
## 文档

[Nextcloud 管理员手册](https://support.websoft9.com/docs/nextcloud)

## 企业级支持

如果需要企业级支持，请订阅我们提供的 [Nextcloud 企业级支持版](https://apps.websoft9.com/nextcloud) 
